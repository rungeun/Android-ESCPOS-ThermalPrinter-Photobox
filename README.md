...
- [x] **포토 박스에 인쇄 매수을 입력 : feature/ATP-2-print-selection)**
    - [x] 인쇄 매수 선택 화면
    - [x] `업`, `다운` 버튼을 통해 인쇄 매수를 조정
    - [x] 현재 선택된 인쇄 매수를 화면에 표시
    - [x] `다음` 버튼을 통해 프레임 개수 선택 화면으로 이동
- [x] **프레임 개수 선택 : (feature/ATP-3-frame-selection)**
    - [x] 프레임 개수 선택 화면
    - [x] `업`, `다운` 버튼을 통해 프레임 개수를 조정
    - [x] 현재 선택된 프레임 개수를 화면에 표시
    - [x] 선택된 프레임 개수에 대한 예상 출력 모양을 화면에 표시
    - [x] `다음` 버튼을 통해 촬영 화면으로 이동
- [ ] **프레임 디자인 선택 : (feature/ATP-8-frame-design-selection)**
    - [x] 프레임 디자인 선택 화면
    - [x] 프레임 적용 페이지 예시 프리뷰 표시
    - [x] 프레임 목록 스크롤 기능
...
- [x] **개인정보 이용동의 : (feature/ATP-5-privacy-policy-consent)**
    ...
    - [x] `다음` 버튼을 통해 촬영 화면으로 이동
- [X] **사진 촬영 : (feature/ATP-6-multi-photo-shoot)**
    - [X] 사진 촬영 화면
    - [X] 프레임에 맞게 사진 N번 촬영
    - [X] 5~1 카운트다운을 화면에 표시 후, 촬영
    - [ ] 촬열 시 부저음 작동
    - [X] 사진을 임시 저장
    - [X] 화면 하단에 촬영된 사진 표시
    - [x] 촬영이 완료된 후, 자동으로 인쇄중 화면으로 이동
- [x] **영수증 인쇄기를 사용한 사진 인쇄 : (feature/ATP-7-photo-printing)**
    - [x] 인쇄중 화면
    - [x] 영수증 인쇄를 위한 데이터 포멧 변환
    - [x] 영수증 인쇄기를 통한 인쇄
    - [x] 로고, 날짜, 사진, 개발자 정보를 포함하여 출력
    - [x] 인쇄 완료 후, 자동으로 초기 화면으로 이동
