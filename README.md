...
- 촬영
    0. 인쇄를 선택한다.
    1. 포토 박스에 인쇄 매수을 입력한다.
    2. 프레임을 선택한다.
    3. 프레임에 맞게 사진 촬영을 n번 한다.
    4. 촬영된 사진을 인쇄한다.
- 재인쇄
    1. 재인쇄를 선택한다.
...
- [ ] **인쇄또는 재인쇄를 선택 : (feature/ATP-1-photo-capture)**
    - [ ] 초기 대기화면
    - [ ] 포토박스 타이틀 및 정보(개발자, 개발 레포, 홍보) 표시
    - [ ] `인쇄` 버튼을 누를 경우 인쇄 화면으로 이동
    - [ ] `재인쇄` 버튼을 누를 경우 재인쇄 화면으로 이동
